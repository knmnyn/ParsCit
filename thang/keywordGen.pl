...
sub Help {
  ...
  print STDERR "       $progname -in taggedHeaderFile -out outFile [-backKeyword] [-n topN -nGram numNGram]\n";
  print STDERR "Options:\n";
  print STDERR "\t-q\tQuiet Mode (don't echo license)\n";
  print STDERR "\t-backKeyword: Find the top-frequent keywords/bigrams appear at the last token(s) of each line.\n";
  print STDERR "\t-n: Default topN = 50.\n";
